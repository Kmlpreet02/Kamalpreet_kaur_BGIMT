...
<div className="min-h-fit w-2/5 p-4 border-2 border-black justify-center items-center rounded-3xl bg-white">
  ...
  >
    {({
      ...
      <Form>
         <h1 className='justify-center items-center ml-16'>Sign up</h1>
     ...
     <button type="submit" className="w-4/5 h-14 border-1 rounded-xl pl-4 text-3xl text-white bg-indigo-300 outline-none mb-4 border-black" >Sign up</button></div>
