...
const Update = ({show,handleClose,setItems}) => {
    const handleSubmit = async(values,{setSubmitting,resetForm}) => {
        ...
        try {
          const res = await API.put("posts",formData,{
            headers:{
...
{({ setFieldValue,values,erroes,touched,isSubmitting}) => (
    <Form>
        ...
        <div> <Button type='submit'  className="p-4" variant="primary" disabled={isSubmitting}>Update</Button></div>
    </Form>
)}
         </Formik>
        </Modal.Body>
